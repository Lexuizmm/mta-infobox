...
### 📦 Installation
1. Download the resource as a `.zip` file or clone the repo:
   ```bash
   git clone [https://github.com/your-username/mta-infobox.git](https://github.com/your-username/mta-infobox.git)
   
---

 ### 💻 Usage / Syntax

exports.infobox:addBox("info", "created CreativeMTA or lexuizm!")
